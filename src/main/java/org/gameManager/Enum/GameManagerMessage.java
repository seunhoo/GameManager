...
public enum GameManagerMessage {
    ...
    // Game Message
    GAME_CREATE_MESSAGE(DEFAULT_MESSAGE.getMessage() + ChatColor.AQUA + "게임이 생성 되었습니다."),
    GAME_START_MESSAGE(DEFAULT_MESSAGE.getMessage() + ChatColor.AQUA + "게임이 시작 되었습니다."),
    GAME_STOP_MESSAGE(DEFAULT_MESSAGE.getMessage() + ChatColor.AQUA + "게임이 종료 되었습니다."),
    GAME_DELETE_MESSAGE(DEFAULT_MESSAGE.getMessage() + ChatColor.AQUA + "게임이 삭제 되었습니다."),
    GAME_SET_SPAWN_MESSAGE(DEFAULT_MESSAGE.getMessage() + ChatColor.AQUA + "게임 스폰장소가 지정 되었습니다."),
    ...
    INFO_COMMAND_EXPLAIN10(ChatColor.AQUA +  "/게임스폰설정"+ ChatColor.WHITE +" 이름"),
    ...
    INFO_COMMAND_EXPLAIN13(ChatColor.AQUA + "/게임목록"),
    INFO_COMMAND_EXPLAIN14(ChatColor.YELLOW +"└ 현재 설정된 게임 목록을 보여줍니다."),
    INFO_COMMAND_EXPLAIN15(ChatColor.YELLOW +"/게임확인"),
    INFO_COMMAND_EXPLAIN16(ChatColor.YELLOW +"└ 현재 게임중인 게임을 확인합니다."),
    ...
    ERROR(DEFAULT_MESSAGE.getMessage() + "오류"),
    ERROR_WRONG_COMMAND(DEFAULT_MESSAGE.getMessage() + ChatColor.RED + "잘못 된 명령입니다."),
    ERROR_GAME_IS_NOT_START(DEFAULT_MESSAGE.getMessage() + ChatColor.RED + "진행중인 게임이 없습니다."),
    ERROR_GAME_IS_ALREADY_START(DEFAULT_MESSAGE.getMessage() + ChatColor.RED + "게임이 이미 진행중입니다."),
    ERROR_GAME_IS_NOT_EXITS(DEFAULT_MESSAGE.getMessage() + ChatColor.RED + "게임이 존재하지 않습니다."),
    ERROR_GAME_IS_NOT_EXITS_SPAWN(DEFAULT_MESSAGE.getMessage() + ChatColor.RED + "게임의 스폰위치가 존재하지 않습니다."),
